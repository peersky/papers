...
\begin{CJK}{UTF8}{gbsn}
    ...
    \begin{abstract}
        This paper introduces a novel protocol for establishing ranking systems in decentralized autonomous organizations (DAOs) and consensus-building protocols. By leveraging cryptographic advancements and social science insights, the protocol enables autonomous decision-making in trustless environments based on agent interactions. We analyze a real-world precedent, a music-sharing game, demonstrating high participation rates even among non-technical users. Our proposed implementations focus on defining interoperable and liquid voting weights for participants in both computational and social networks. We also discuss potential economic models and game-theoretic implications of such competence frameworks. This research aims to address key challenges in autonomous governance, such as low participation, centralization, and lack of commitment mechanisms, by fostering a more engaging, equitable, and secure decision-making process.
    ...
    \begin{multicols}{2}
        ...
        Both on consensus layer based on continuous proving and application layer with share-holder voting we identified different problems.
        ...
        The protocol essentially establishes a framework for rating not only participants but also ideas themselves, decoupled from personalities. Its continuous nature enables deeper alignment among participants by utilizing previous round results as feedback from their group. This fosters empathy between participants as they iteratively refine their understanding of collective preferences.

        Beyond personal empathy, this property holds significant value for Cyber-Physical-Social Systems (CPSS). It enables benchmarking AI agents participating in such games, with feedback and historical data forming a robust, personalized machine learning framework.

        Depending on the application, the outcomes of rated proposals have diverse use cases. Top-scoring proposals can automate execution processes, such as formulating rated agendas (e.g., playlists for public events) or pre-assigned weights for voting lists.

        Furthermore, this approach extends to mission-specific tasks like code development. Programmers can iteratively share, vote on, and refine code until a deadline, with later iterations potentially weighted more heavily.
