...
% Title and author
\title{Autonomous competence identification protocol: A framework for dynamic, interoperable, Ranking Ladder}
...
\begin{CJK}{UTF8}{gbsn}
    ...
    \begin{abstract}
        This paper introduces a novel protocol for establishing ranking systems in Decentralized Autonomous Organizations (DAOs) and consensus-building protocols. Leveraging cryptographic and social science insights, the protocol enables autonomous decision-making in trustless environments based on agent interactions. The proposed protocol addresses key challenges in autonomous governance, such as low participation, centralization, and lack of commitment mechanisms, by fostering a more engaging, equitable, and secure decision-making process. It also has potential applications in various domains beyond DAOs, including corporate governance, academic research, and online education.
    \end{abstract}
    \begin{multicols}{2}
        ...
        \begin{itemize}[nosep]
            ...
            \item Discuss potential practical utilization of such competence framework.
        \end{itemize}
